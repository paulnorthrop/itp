...
res2 <- wrap_itpC(wiki_ptr, c(1, 2), k1 = 0.1, n0 = 1)
...
res2 <- wrap_itpC(neg_wiki_ptr, c(1, 2), k1 = 0.1, n0 = 1)
...
res2 <- wrap_itpC(lambert_ptr, c(-1, 1))
...
res2 <- wrap_itpC(trig1_ptr, c(-1, 1), root = 1 / 10)
...
res2 <- wrap_itpC(poly3_ptr, c(-1, 1))
...
res2 <- wrap_itpC(linear_ptr, c(-1, 1))
...
res2 <- wrap_itpC(staircase_ptr, c(-1, 1))
